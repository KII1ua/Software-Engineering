...
### 샘플 코드 모듈 평가 결과
- 응집도 평가
  1. MenuService 클래스는 메뉴 엔티티 조회에만 책임을 지고 있기 때문에 MenuService에 대해서는 응집도가 높다고 평가할 수 있다고 생각합니다.
...
- 결합도 평가
  ...
  2. 마찬가지로 Order 객체와 Kitchen 객체의 의존성은 어느정도 있다고 생각합니다. 이 부분은 적절한 결합도라고 생각합니다.
